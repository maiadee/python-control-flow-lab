...
def weather_advice():
    ...
    is_cold = input("Is it cold? Enter 'yes' or 'no': ").lower()
    is_raining = input("Is it raining? Enter 'yes' or 'no': ").lower()
...
def determine_season():
    # You control flow logic goes here
    ...
    if month in ["Dec", "Jan", "Feb"]:
        ...
        season = "Spring"
    elif month == "Jun" and day >= 21 or month in ["Jul", "Aug"]:
        season = "Summer"
    elif month == "Sep" and day >= 22 or month in ["Oct", "Nov"]:
        season = "Fall"
...
def guess_number():
    ...
    for guess_num in range(attempts):
